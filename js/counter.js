...
var countdown = function() {
    ...
    function C(a, b) { return x(a) + (1 === a ? p[b] : q[b]) }
    ...
    function A(a, b, c, e, l, d) {
        ...
        try {
            ...
            !(e & 64) || b >= l ? (a.months && (a.days += z(a.refMonth, a.months)), delete a.months,
            ...
            if (!(e & 1) || b >= l) {
                ...
                if (h && (h = k(a, h, "seconds", "minutes", 60, d)) && (h =
                        k(a, h, "minutes", "hours", 60, d)) && (h = k(a, h, "hours", "days", 24, d)) && (h = k(a, h, "days", "weeks", 7, d)) && (h = k(a, h, "weeks", "months", v(a.refMonth) / 7, d))) {
                    e = h;
                    var n, p = a.refMonth,
                        q = p.getTime(),
                        r = new Date(q);
    ...
    function d(a, b, c, e, d) {
        ...
        var k = c & 1 ? 1E3 / 30 : c & 2 ? 1E3 : c & 4 ? 6E4 : c & 8 ? 36E5 : c & 16 ? 864E5 : 6048E5,
            h, g = function() { f(A(new n, a, b, c, e, d), h) };
        g();
    ...
    d.setLabels = function(a, b, c, d, f, k, m) { D({ singular: a, plural: b, last: c, delim: d, empty: f, formatNumber: k, formatter: m }) };
    d.resetLabels = B;
    B();
    "undefined" !== typeof module && module.exports ? module.exports = d : "undefined" !== typeof window && ("function" ===
        typeof window.define && "undefined" !== typeof window.define.amd) && window.define("countdown", [], function() { return d });
    return d
}();